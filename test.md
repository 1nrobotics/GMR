...
For a ForSense BVH recording on Fourier N1:
...
To publish Fourier N1-specific topic names:
...
## Offline Fourier N1 Retargeting

Use this command to preview ForSense BVH retargeting on Fourier N1 without ROS:
...
To save the retargeted Fourier N1 motion:
